USE sai;
CREATE TABLE COUNTRY(COUNTRY_CODE CHAR(4) PRIMARY KEY,
                     COUNTRY_NAME VARCHAR(15),
                     REGION VARCHAR(15));
CREATE TABLE CATEGORY(CATEGORY_CODE CHAR(4) PRIMARY KEY,
                       CATEGORY_DESC VARCHAR(20));
CREATE TABLE CUSTOMER(CUSTOMER_CODE CHAR(4) PRIMARY KEY,
                      CUSTOMER_NAME VARCHAR(20),
                      CREDIT_LIMIT INT);
CREATE TABLE BRANCH(BRANCH_CODE CHAR(4) PRIMARY KEY,
                    BRANCH_NAME VARCHAR(15),
                    COUNTRY_CODE CHAR(4),
                    FOREIGN KEY(country_code)
                    REFERENCES COUNTRY(COUNTRY_CODE));
CREATE TABLE SALESREP(SALESREP_ID CHAR(4) PRIMARY KEY,
                      SALESREP_NAME VARCHAR(20),
                      SALESREP_DOJ DATETIME,
                      MGR CHAR(4),
                      BRANCH_CODE CHAR(4),
                      FOREIGN KEY(BRANCH_CODE)
                      REFERENCES BRANCH(BRANCH_CODE),
                      SALARY NUMERIC(7));
CREATE TABLE PRODUCT(PRODUCT_CODE CHAR(4) PRIMARY KEY,
                     PROD_DESC VARCHAR(30),
                     CATEGORY_CODE CHAR(4),
                      FOREIGN KEY(CATEGORY_CODE)
                     REFERENCES CATEGORY(CATEGORY_CODE),
                     PRICE NUMERIC(7),
                     QTY_ON_HAND NUMERIC(3));
CREATE TABLE ORDER_MASTER(ORDER_CODE CHAR(4) PRIMARY KEY,
                          ORDER_DATE DATETIME,
                          SALESREP_ID CHAR(4) ,
...
CREATE TABLE ORDER_DETAIL(ORDER_CODE CHAR(4) ,
						  FOREIGN KEY(ORDER_CODE)REFERENCES ORDER_MASTER(ORDER_CODE),
                          PRODUCT_CODE CHAR(4),
                          FOREIGN KEY(PRODUCT_CODE) REFERENCES PRODUCT(PRODUCT_CODE),
                          QTY_ORDERED NUMERIC(3),
                          CONSTRAINT CP PRIMARY KEY(ORDER_CODE,PRODUCT_CODE));

INSERT INTO COUNTRY (COUNTRY_CODE,country_name,REGION) VALUES('CY01','INDIA','SOUTHERN');
...
INSERT INTO SALESREP VALUES('SP02','MADHAN','2003-05-13','SP03','BR01',35000);
...
INSERT INTO SALESREP VALUES('SP05','SANTHIYA','2008-10-14','SP01','BR04',15000);

INSERT INTO SALESREP VALUES('SP06','HEMA','2005-12-07','SP04','BR05',22000);

INSERT INTO SALESREP VALUES('SP07','NITHYA','2006-01-27','SP05','BR06',12000);

INSERT INTO SALESREP VALUES('SP08','SHANTHI','2007-02-01','SP05','BR04',18000);
...
INSERT INTO ORDER_MASTER VALUES('OR01','2008-03-07','SP01','CU01');
...
INSERT INTO ORDER_MASTER VALUES('OR07','2008-11-19','SP04','CU06');

INSERT INTO ORDER_MASTER VALUES('OR08','2009-05-27','SP01','CU02');

INSERT INTO ORDER_MASTER VALUES('OR09','2010-03-31','SP06','CU01');

INSERT INTO ORDER_MASTER VALUES('OR10','2000-09-01','SP05','CU07');

INSERT INTO ORDER_MASTER VALUES('OR11','2010-07-02','SP07','CU09');

INSERT INTO ORDER_MASTER VALUES('OR12','2010-08-22','SP08','CU09');
